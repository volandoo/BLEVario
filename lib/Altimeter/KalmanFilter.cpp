...
KalmanFilter::KalmanFilter(double var_accel)
{
    x_abs_ = 0.0;
    x_vel_ = 0.0;
    p_abs_abs_ = 0.0;
...
void KalmanFilter::reset(double abs_value, double vel_value)
{
    x_abs_ = abs_value;
    x_vel_ = vel_value;
    p_abs_abs_ = 1.e10;
...
void KalmanFilter::update(double z_abs, double var_z_abs, double dt)
{
